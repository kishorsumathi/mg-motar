...
$( document ).ready(function() {
  ...
  if (!('webkitSpeechRecognition' in window)) {
    ...
    recognition.onstart = function() {
      recognizing = true;
      showInfo('speak_now');
      start_img.src = '/root/mg_poc/static/images/mic-animation.gif';
    };

    recognition.onerror = function(event) {
      if (event.error == 'no-speech') {
        start_img.src = '/root/mg_poc/static/images/mic.gif';
        showInfo('no_speech');
        ignore_onend = true;
      }
      if (event.error == 'audio-capture') {
        start_img.src = '/root/mg_poc/static/images/images/mic.gif';
...
$("#start_button").click(function () {
  ...
  start_img.src = '/root/mg_poc/static/images/mic-slash.gif';
  showInfo('allow');
